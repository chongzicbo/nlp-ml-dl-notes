...
霍夫曼树的定义为：在权为 ![[公式]](https://www.zhihu.com/equation?tex=w_1%2Cw_2%2C...%2Cw_n) 的 ![[公式]](https://www.zhihu.com/equation?tex=n) 个叶子结点所构成的所有二叉树中，带权路径长度最小的二叉树称为**最优二叉树**或**霍夫曼树**。
